...
docker run --rm -v /Users/moto/work/lamarr-sm/nuke-lamarr/nuke-config.yml:/home/aws-nuke/config.yml -v ~/.aws:/home/aws-nuke/.aws docker.io/rebuy/aws-nuke --profile nuke-lamarr --config /home/aws-nuke/config.yml
